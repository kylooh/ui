...
Install `tailwindcss@3` and its peer dependencies, then generate your `tailwind.config.js` and `postcss.config.js` files:

> since `tailwindcss` latest is `v4`, please use `tailwindcss@3`
